...
#ifndef OPFLOW_FIRSTORDERWENO53UPWIND_HPP
#define OPFLOW_FIRSTORDERWENO53UPWIND_HPP
...
namespace OpFlow {
    ...
    private:
        OPFLOW_STRONG_INLINE static auto kernel(auto pm2, auto pm1, auto p0, auto pp1, auto pp2, auto pp3,
                                                auto h) {
            auto d1 = (pp3 - pp2) / h, d2 = (pp2 - pp1) / h, d3 = (pp1 - p0) / h, d4 = (p0 - pm1) / h,
                 d5 = (pm1 - pm2) / h;
    ...
    namespace internal {
        ...
        struct ExprTrait<Expression<D1WENO53Upwind<d>, T>> : ExprTrait<T> {
            static constexpr int bc_width
                    = D1WENO53Upwind<d>::bc_width + CartesianFieldExprTrait<T>::bc_width;
...
#endif//OPFLOW_FIRSTORDERWENO53UPWIND_HPP
