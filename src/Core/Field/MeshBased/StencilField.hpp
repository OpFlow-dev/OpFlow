...
namespace OpFlow
{
        ...
        : internal::StructuredFieldExprTrait<T>::template twin_type<StencilField<T, map_impl>>
    {
        ...
        explicit StencilField(const T& base, int color = 0) : color(color), base(&base)
        {
        ...
        auto evalAtImpl_final(const index_type& index) const
        {
            ...
            {
                // needs boundary condition info to continue
    ...
    private:
        ...
        std::vector<std::vector < typename internal::ExprTrait < typename internal::ExprTrait <
            T>::template other_type<DS::StencilPad<colored_index_type, map_impl>>
        >
        ::container_type
        >
        >
        ...
        std::vector<std::vector < typename internal::ExprTrait <
            typename internal::ExprTrait < T>::template other_type<bool>
        >
        ::container_type
        >
        >
