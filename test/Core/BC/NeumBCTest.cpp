...
class NeumBCTest : public testing::Test {
protected:
...
TEST_F(NeumBCTest, CornerNeumWithExtValCheck) {
    auto u = ExprBuilder<Field>()
                     .setMesh(m)
                     .setBC(0, DimPos::start, BCType::Neum, 1.)
                     .setBC(0, DimPos::end, BCType::Neum, 1.)
...
TEST_F(NeumBCTest, CenterNeumWithExtValCheck) {
    auto u = ExprBuilder<Field>()
                     .setMesh(m)
                     .setBC(0, DimPos::start, BCType::Neum, 1.)
                     .setBC(0, DimPos::end, BCType::Neum, 1.)
