...
namespace tbb {
    ...
    @ingroup synchronization */
            ...
            public:
                //! Constructors
                spin_mutex() noexcept : m_flag(false) { create_itt_sync(this, "tbb::spin_mutex", ""); };
                ...
                bool try_lock() {
                    ...
                    if (result) { call_itt_notify(acquired, this); }
                    return result;
                }
            ...
            inline void set_name(spin_mutex& obj, const char* name) { itt_set_sync_name(&obj, name); }
#if (_WIN32 || _WIN64)
            inline void set_name(spin_mutex& obj, const wchar_t* name) { itt_set_sync_name(&obj, name); }
#endif//WIN
#else
