...
namespace tbb {
    namespace detail {
            ...
            struct constraints {
                ...
                constraints(numa_node_id id = -1, int maximal_concurrency = -1)
                    : numa_id(id), max_concurrency(maximal_concurrency)
                      ...
                      ,
                      core_type(-1), max_threads_per_core(-1)
#endif
                {
                }
        ...
        namespace r1 {
            ...
            TBB_EXPORT void __TBB_EXPORTED_FUNC fill_core_type_indices(int* index_array,
                                                                       intptr_t reserved = 0);

            TBB_EXPORT int __TBB_EXPORTED_FUNC constraints_default_concurrency(const d1::constraints& c,
                                                                               intptr_t reserved = 0);
            TBB_EXPORT int __TBB_EXPORTED_FUNC constraints_threads_per_core(const d1::constraints& c,
                                                                            intptr_t reserved = 0);
        }// namespace r1
        ...
        namespace d1 {
            ...
            inline int default_concurrency(numa_node_id id = -1) { return r1::numa_default_concurrency(id); }
