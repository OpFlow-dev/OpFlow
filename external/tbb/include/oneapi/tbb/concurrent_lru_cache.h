        ...
        namespace d1 {
            ...
            private:
                ...
                void signal_end_of_usage_serial(storage_map_reference_type map_record_ref) {
                    ...
                    __TBB_ASSERT(std::find(my_history_list.begin(), my_history_list.end(), map_it)
                                         == my_history_list.end(),
                    ...
                    if (!--(map_it->second.my_ref_counter)) {
                        ...
                        if (my_history_list.size() >= my_history_list_capacity) {
                            std::size_t number_of_elements_to_evict
            ...
            public:
                ...
                handle_object(handle_object&& other)
                    ...
                    __TBB_ASSERT((other.my_lru_cache_ptr != nullptr && other.my_map_record_ptr != nullptr)
                ...
                handle_object& operator=(handle_object&& other) {
                    ...
                    if (my_lru_cache_ptr) my_lru_cache_ptr->signal_end_of_usage(*my_map_record_ptr);
                ...
                operator bool() const { return (my_lru_cache_ptr && my_map_record_ptr); }
            ...
            public:
                retrieve_aggregator_operation(key_type key)
                    : aggregator_operation(aggregator_operation::op_type::retrieve), my_key(key),
            ...
            struct concurrent_lru_cache<KeyT, ValT,
                                        KeyToValFunctorT>::signal_end_of_usage_aggregator_operation
                : aggregator_operation,
                  private no_assign {
