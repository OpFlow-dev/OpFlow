...
namespace tbb {
    namespace detail {
        namespace d2 {
            ...
            template <typename Key, typename KeyCompare, typename RandomGenerator, typename Allocator,
            ...
            class concurrent_set
                : public concurrent_skip_list<set_traits<
                          Key, Compare, concurrent_geometric_level_generator<32>, Allocator, false>> {
                using base_type = concurrent_skip_list<
                        set_traits<Key, Compare, concurrent_geometric_level_generator<32>, Allocator, false>>;
            ...
            template <typename Key, typename Comp = std::less<Key>, typename Alloc = tbb::tbb_allocator<Key>,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>,
                      typename = std::enable_if_t<!is_allocator_v<Comp>>>
            ...
            template <typename Key, typename Alloc, typename = std::enable_if_t<is_allocator_v<Alloc>>>
            concurrent_set(std::initializer_list<Key>, Alloc) -> concurrent_set<Key, std::less<Key>, Alloc>;
            ...
            class concurrent_multiset
                ...
                using base_type = concurrent_skip_list<
                        set_traits<Key, Compare, concurrent_geometric_level_generator<32>, Allocator, true>>;
