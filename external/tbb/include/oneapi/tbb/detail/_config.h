...
#define __TBB_WEAK_SYMBOLS_PRESENT                                                                           \
    (!_WIN32 && !__APPLE__ && !__sun && (__TBB_GCC_VERSION >= 40000 || __INTEL_COMPILER))
#endif
...
#define __TBB_CPP17_DEDUCTION_GUIDES_PRESENT                                                                 \
    (_MSC_VER >= 1914 && __TBB_LANG >= 201703L && (!__INTEL_COMPILER || __INTEL_COMPILER > 2021))
...
#define __TBB_CPP11_GET_NEW_HANDLER_PRESENT                                                                  \
    (_MSC_VER >= 1900 || __TBB_GLIBCXX_VERSION >= 40900 && __GXX_EXPERIMENTAL_CXX0X__ || _LIBCPP_VERSION)
// GCC4.8 on RHEL7 does not support std::is_trivially_copyable
#define __TBB_CPP11_TYPE_PROPERTIES_PRESENT                                                                  \
    (_LIBCPP_VERSION || _MSC_VER >= 1700 || (__TBB_GLIBCXX_VERSION >= 50000 && __GXX_EXPERIMENTAL_CXX0X__))

#define __TBB_CPP17_MEMORY_RESOURCE_PRESENT                                                                  \
    (_MSC_VER >= 1913 && (__TBB_LANG > 201402L) || __TBB_GLIBCXX_VERSION >= 90000 && __TBB_LANG >= 201703L)
...
#define __TBB_CPP20_COMPARISONS_PRESENT                                                                      \
    ((__cpp_impl_three_way_comparison >= 201907L) && (__cpp_lib_three_way_comparison >= 201907L))
#else
...
#define __TBB_WAITPKG_INTRINSICS_PRESENT                                                                     \
    ((__INTEL_COMPILER >= 1900 || __TBB_GCC_VERSION >= 110000 || __TBB_CLANG_VERSION >= 120000)              \
     && !__ANDROID__)
...
#if !defined(__TBB_SURVIVE_THREAD_SWITCH) && (_WIN32 || _WIN64 || __APPLE__ || (__unix__ && !__ANDROID__))
