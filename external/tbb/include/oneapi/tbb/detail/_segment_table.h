        ...
        namespace d1 {
            ...
            protected:
                using segment_table_allocator_traits
                        = tbb::detail::allocator_traits<segment_table_allocator_type>;
            ...
            public:
                ...
                segment_table(const segment_table& other)
                    : my_segment_table_allocator(
                      ...
                      my_segment_table(my_embedded_table), my_first_block {}, my_size {},
                ...
                operator=(segment_table&& other) noexcept(derived_type::is_noexcept_assignment) {
                    using pocma_type =
                            typename segment_table_allocator_traits::propagate_on_container_move_assignment;
                    using is_equal_type = typename segment_table_allocator_traits::is_always_equal;
                ...
                value_type& operator[](size_type index) { return internal_subscript<true>(index); }
                ...
                segment_table_allocator_type& get_allocator() { return my_segment_table_allocator; }
                ...
                void enable_segment(segment_type& segment, segment_table_type table,
                    ...
                    __TBB_ASSERT(
                            segment != nullptr,
                            "If create_segment returned nullptr, the element should be stored in the table");
                }
                ...
                void delete_segment(segment_index_type seg_index) {
                    ...
                    if (segment_to_delete == segment_allocation_failure_tag) { return; }
                ...
                void clear_table() {
                    ...
                    if (current_segment_table != my_embedded_table) {
                        ...
                        segment_table_allocator_traits::deallocate(
                                my_segment_table_allocator, current_segment_table, pointers_per_long_table);
            ...
            private:
                ...
                void internal_transfer(const segment_table& other, TransferBody transfer_segment) {
                    ...
                    for (segment_index_type i = 0; segment_base(i) < other_size; ++i) {
                        ...
                        if (other_table[i].load(std::memory_order_relaxed)
                            ...
                            transfer_segment(
                                    i, other.get_table()[i].load(std::memory_order_relaxed) + segment_base(i),
                ...
                // Move construct the segment table with the allocator object
                // if any instances of allocator_type are always equal
                void internal_move_construct_with_allocator(segment_table&& other,
                ...
                void internal_swap_fields(segment_table& other) {
                    ...
                    if (get_table() == my_embedded_table || other.get_table() == other.my_embedded_table) {
            ...
            protected:
                ...
                value_type& internal_subscript(size_type index) {
                    ...
                    if (allow_out_of_range_access) {
                        ...
                        if (segment == nullptr) { enable_segment(segment, table, seg_index, index); }
