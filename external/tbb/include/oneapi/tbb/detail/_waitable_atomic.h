...
namespace tbb {
    namespace detail {
        ...
        namespace r1 {
            TBB_EXPORT void __TBB_EXPORTED_FUNC wait_on_address(void* address,
                                                                d1::delegate_base& wakeup_condition,
        ...
        namespace d1 {
            ...
            public:
                ...
                T load(std::memory_order order) const noexcept { return my_atomic.load(order); }

                T exchange(T desired) noexcept { return my_atomic.exchange(desired); }
                ...
                void wait(T old, std::uintptr_t context, std::memory_order order) {
                    ...
                    if (!timed_spin_wait_until(wakeup_condition)) {
                        ...
                        do { r1::wait_on_address(this, pred, context); } while (!wakeup_condition());
                    }
                }
                ...
                void notify_relaxed(std::uintptr_t context) { r1::notify_by_address(this, context); }

                void notify_one_relaxed() { r1::notify_by_address_one(this); }
