...
#pragma warning(disable : 4324)
            ...
            public:
                ...
                public:
                    ...
                    ~scoped_lock() {
                        if (m_transaction_state != rtm_type::rtm_not_in_mutex) { release(); }
                    }
...
#pragma warning(pop)// 4324 warning
        ...
        namespace d1 {
            ...
            inline void set_name(rtm_rw_mutex& obj, const char* name) { itt_set_sync_name(&obj, name); }
#if (_WIN32 || _WIN64)
            inline void set_name(rtm_rw_mutex& obj, const wchar_t* name) { itt_set_sync_name(&obj, name); }
#endif// WIN
#else
