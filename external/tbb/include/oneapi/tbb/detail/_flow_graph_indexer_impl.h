...
struct indexer_helper {
    ...
    static inline void set_indexer_node_pointer(PortTuple &my_input, IndexerNodeBaseType *p, graph &g) {
        ...
        indexer_helper<TupleTypes, N - 1>::template set_indexer_node_pointer<IndexerNodeBaseType, PortTuple>(
                my_input, p, g);
    }
};
...
protected:
    ...
    graph_task *try_put_task(const T &v) override { return my_try_put_task(v, my_indexer_ptr); }
...
struct input_types<5, InputTuple> {
    ...
    typedef tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type> type;
};
...
struct input_types<6, InputTuple> {
    ...
    typedef tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type> type;
};
...
struct input_types<7, InputTuple> {
    ...
    typedef tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type,
                       seventh_type>
            type;
};
...
struct input_types<10, InputTuple> {
    ...
    typedef tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type,
                       seventh_type, eighth_type, nineth_type, tenth_type>
            type;
};
