...
#pragma warning(disable : 4324)
    ...
    @ingroup synchronization */
            ...
            public:
                //! Constructors
                rtm_mutex() noexcept { create_itt_sync(this, "tbb::speculative_spin_mutex", ""); }
                ...
                public:
                    ...
                    ~scoped_lock() {
                        if (m_transaction_state != rtm_state::rtm_none) { release(); }
                    }
        ...
        namespace r1 {
            ...
            TBB_EXPORT void __TBB_EXPORTED_FUNC acquire(d1::rtm_mutex&, d1::rtm_mutex::scoped_lock&,
...
#pragma warning(pop)// 4324 warning
            ...
            inline void set_name(rtm_mutex& obj, const char* name) { itt_set_sync_name(&obj, name); }
#if (_WIN32 || _WIN64)
            inline void set_name(rtm_mutex& obj, const wchar_t* name) { itt_set_sync_name(&obj, name); }
#endif// WIN
#else
