    ...
    namespace detail {
        ...
        namespace d1 {
            ...
            public:
                ...
                ~cpu_ctl_env() {
                    if (my_fenv_ptr) r1::cache_aligned_deallocate((void*) my_fenv_ptr);
                }
                ...
                cpu_ctl_env(const cpu_ctl_env& src) : my_fenv_ptr(NULL) { *this = src; }
                cpu_ctl_env& operator=(const cpu_ctl_env& src) {
                    __TBB_ASSERT(src.my_fenv_ptr, NULL);
                    if (!my_fenv_ptr) my_fenv_ptr = (fenv_t*) r1::cache_aligned_allocate(sizeof(fenv_t));
