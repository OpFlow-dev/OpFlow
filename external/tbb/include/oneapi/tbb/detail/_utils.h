  ...
  @ingroup memory_allocation */
      ...
      that take the same time as an context switch. Must be a power of two.*/
            ...
            bool timed_spin_wait_until(Condition condition) {
                ...
                for (int i = 1; !finish && i < 32; finish = condition(), i *= 2) { machine_pause(i); }
                for (int i = 32; !finish && i < 64; finish = condition(), ++i) { yield(); }
                return finish;
            }
    ...
    /param state Shared state associated with initializer that specifies its
            ...
            struct synthesized_three_way_comparator {
                ...
                auto operator()(const T1& lhs, const T2& rhs) const requires requires {
            ...
            using synthesized_three_way_result
                    = decltype(synthesized_three_way_comparator {}(std::declval<T1&>(), std::declval<T2&>()));
        ...
        namespace d1 {
            ...
            public:
                ...
                bool operator()() const override { return my_func(); }
