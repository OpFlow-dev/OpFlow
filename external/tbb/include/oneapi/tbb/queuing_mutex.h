    ...
    namespace detail {
        namespace d1 {
            ...
            public:
                ...
                queuing_mutex() noexcept { create_itt_sync(this, "tbb::queuing_mutex", ""); };
        ...
        It also nicely provides the "node" for queuing locks. */
                ...
                public:
                    ...
                    scoped_lock(queuing_mutex& m) { acquire(m); }
                    ...
                    void acquire(queuing_mutex& m) {
                        ...
                        if (pred) {
                            ...
                            __TBB_ASSERT(pred->m_next.load(std::memory_order_relaxed) == nullptr,
            ...
            inline void set_name(queuing_mutex& obj, const char* name) { itt_set_sync_name(&obj, name); }
#if (_WIN32 || _WIN64)
            inline void set_name(queuing_mutex& obj, const wchar_t* name) { itt_set_sync_name(&obj, name); }
#endif//WIN
#else
