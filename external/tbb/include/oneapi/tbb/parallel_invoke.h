        ...
        namespace d1 {
            ...
            struct function_invoker : public task {
                function_invoker(const Function& function, WaitObject& wait_ctx)
                    : my_function(function), parent_wait_ctx(wait_ctx) {}
            ...
            struct invoke_subroot_task : public task {
                ...
                invoke_subroot_task(const F1& f1, const F2& f2, const F3& f3, wait_context& wait_ctx,
                                    task_group_context& context, small_object_allocator& alloc)
                    : root_wait_ctx(wait_ctx), self_invoked_functor(f1), f2_invoker(f2, *this),
                      f3_invoker(f3, *this), my_execution_context(context), my_allocator(alloc) {
            ...
            public:
                ...
                void release(const execution_data&) { my_wait_context.release(); }
            ...
            void invoke_recursive_separation(wait_context& root_wait_ctx, task_group_context& context,
                ...
                auto sub_root = alloc.new_object<invoke_subroot_task<F1, F2, F3>>(f1, f2, f3, root_wait_ctx,
                                                                                  context, alloc);
            ...
            struct invoke_helper<std::tuple<Args...>, T, Fs...>
                : invoke_helper<std::tuple<Args..., T>, Fs...> {};
