...
namespace tbb {
    ...
    @ingroup synchronization */
            ...
            public:
                ...
                queuing_rw_mutex() noexcept { create_itt_sync(this, "tbb::queuing_rw_mutex", ""); }

                //! Destructor asserts if the mutex is acquired, i.e. q_tail is non-NULL
                ~queuing_rw_mutex() {
                    __TBB_ASSERT(q_tail.load(std::memory_order_relaxed) == nullptr,
        ...
        It also nicely provides the "node" for queuing locks. */
                class scoped_lock {
                    ...
                    void initialize() {
                        ...
                        my_next.store(reinterpret_cast<uintptr_t>(reinterpret_cast<void*>(-1)),
                                      std::memory_order_relaxed);
                        my_prev.store(reinterpret_cast<uintptr_t>(reinterpret_cast<void*>(-1)),
                                      std::memory_order_relaxed);
            ...
            inline void set_name(queuing_rw_mutex& obj, const char* name) { itt_set_sync_name(&obj, name); }
#if (_WIN32 || _WIN64)
        ...
        namespace d1 {
            ...
            inline void queuing_rw_mutex::scoped_lock::release() { r1::release(*this); }
            ...
            inline bool queuing_rw_mutex::scoped_lock::is_writer() const { return r1::is_writer(*this); }
        }// namespace d1
