    ...
    namespace detail {
        ...
        namespace d1 {
            ...
            public:
                ...
                global_control(parameter p, std::size_t value) : my_value(value), my_reserved(), my_param(p) {
            ...
            private:
                std::size_t my_value;
                std::intptr_t
                        my_reserved;// TODO: substitution of global_control* not to break backward compatibility
                parameter my_param;
            ...
            public:
                ...
                ~task_scheduler_handle() { release(*this); }
                ...
                explicit operator bool() const noexcept { return m_ctl != nullptr; }
                ...
                static void release(task_scheduler_handle& handle) {
                    if (handle.m_ctl != nullptr) { r1::finalize(handle, release_nothrowing); }
                }
            ...
            inline void finalize(task_scheduler_handle& handle) { r1::finalize(handle, finalize_throwing); }
#endif
