...
namespace tbb {
    namespace detail {
        ...
        inline namespace d0 {
            ...
            concept compare = requires(const std::remove_reference_t<Compare>& comp,
            ...
            concept less_than_comparable
                    = requires(const std::remove_reference_t<T>& lhs, const std::remove_reference_t<T>& rhs) {
    ...
    @ingroup algorithms */
            ...
            class quick_sort_range {
                std::size_t median_of_three(const RandomAccessIterator& array, std::size_t l, std::size_t m,
                                            std::size_t r) const {
                ...
                std::size_t pseudo_median_of_nine(const RandomAccessIterator& array,
            ...
            public:
                ...
                quick_sort_range(quick_sort_range& range, split)
                    : comp(range.comp), size(split_range(range))
            ...
            void parallel_quick_sort(RandomAccessIterator begin, RandomAccessIterator end,
                ...
                for (; k != begin + serial_cutoff; ++k) {
                    if (comp(*(k + 1), *k)) { do_parallel_quick_sort(begin, end, comp); }
                }
                ...
                if (my_context.is_group_execution_cancelled()) do_parallel_quick_sort(begin, end, comp);
            }
...
**/
    ...
    @ingroup algorithms **/
            ...
            __TBB_requires(std::random_access_iterator<RandomAccessIterator>&& compare<
                           Compare, RandomAccessIterator>) void parallel_sort(RandomAccessIterator begin,
            ...
            __TBB_requires(std::random_access_iterator<RandomAccessIterator>&& less_than_comparable<
            ...
            __TBB_requires(container_based_sequence<Range, std::random_access_iterator_tag>&& compare<
                           Compare, range_iterator_type<Range>>) void parallel_sort(Range& rng,
                                                                                    const Compare& comp) {
