...
namespace tbb {
    namespace detail {
        ...
        namespace r1 {
            TBB_EXPORT void __TBB_EXPORTED_FUNC parallel_pipeline(task_group_context&, std::size_t,
        ...
        namespace d1 {
            ...
            public:
                ...
                void operator=(const filter& rhs) { my_root = rhs.my_root; }
                void operator=(filter&& rhs) { my_root = std::move(rhs.my_root); }
            ...
            filter<InputType, OutputType> make_filter(filter_mode mode, const Body& body) {
                return filter_node_ptr(
                        new (r1::allocate_memory(sizeof(filter_node_leaf<InputType, OutputType, Body>)))
                                filter_node_leaf<InputType, OutputType, Body>(static_cast<unsigned int>(mode),
                                                                              body));
            }
            ...
            void parallel_pipeline(size_t max_number_of_live_tokens, const F1& filter1, const F2& filter2,
