    ...
    namespace detail {
        namespace d1 {
            ...
            struct concurrent_unordered_set_traits {
                ...
                static constexpr const key_type& get_key(const value_type& value) { return value; }
            ...
            public:
                ...
                concurrent_unordered_set(const concurrent_unordered_set& other, const allocator_type& alloc)
                    : base_type(other, alloc) {}
                concurrent_unordered_set(concurrent_unordered_set&&) = default;
                concurrent_unordered_set(concurrent_unordered_set&& other, const allocator_type& alloc)
                ...
                void
                merge(concurrent_unordered_set<key_type, OtherHash, OtherKeyEqual, allocator_type>& source) {
                ...
                template <typename OtherHash, typename OtherKeyEqual>
                void merge(concurrent_unordered_multiset<key_type, OtherHash, OtherKeyEqual, allocator_type>&
                                   source) {
                    this->internal_merge(source);
                }
            ...
            concurrent_unordered_set(It, It, std::size_t = {}, Hash = Hash(), KeyEq = KeyEq(),
                                     Alloc = Alloc())
            ...
            template <typename T, typename Hash = std::hash<T>, typename KeyEq = std::equal_to<T>,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_set(std::initializer_list<T>, std::size_t = {}, Hash = Hash(),
            ...
            template <typename It, typename Hash = std::hash<iterator_value_t<It>>,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(It, It, std::size_t = {}, Hash = Hash(), KeyEq = KeyEq(),
                                          Alloc = Alloc())
            ...
            template <typename T, typename Hash = std::hash<T>, typename KeyEq = std::equal_to<T>,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(std::initializer_list<T>, std::size_t = {}, Hash = Hash(),
                                          KeyEq = KeyEq(), Alloc = Alloc())
