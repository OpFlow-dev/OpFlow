...
/* assume MapMemory and UnmapMemory are customized */
        ...
        void *Backend::remap(void *ptr, size_t oldSize, size_t newSize, size_t alignment) {
            ...
            if (!right->isLastRegionBlock()) return NULL;
            ...
            if (oldRegion->type != MEMREG_ONE_BLOCK) return NULL;// we are not single in the region
        ...
        FreeBlock *Backend::findBlockInRegion(MemRegion *region, size_t exactBlockSize) {
            ...
            if (fBlockEnd <= (uintptr_t) fBlock) return NULL;// allocSz is too small
            ...
            if (blockSz < numOfSlabAllocOnMiss * slabSize) return NULL;
