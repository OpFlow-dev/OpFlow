...
#undef TBB_STRING_RESOURCE
    ...
    Used by dummy handlers only. **/
            ...
            void call_itt_notify(int t, void *ptr) {
                switch (t) {
                    case 0:
                        ITT_NOTIFY(sync_prepare, ptr);
                        break;
                    case 1:
                        ITT_NOTIFY(sync_cancel, ptr);
                        break;
                    case 2:
                        ITT_NOTIFY(sync_acquired, ptr);
                        break;
                    case 3:
                        ITT_NOTIFY(sync_releasing, ptr);
                        break;
                    case 4:
                        ITT_NOTIFY(sync_destroy, ptr);
                        break;
                }
            }

            void itt_set_sync_name(void *obj, const tchar *name) { __itt_sync_rename(obj, name); }

            const __itt_id itt_null_id = {0, 0, 0};

            static inline __itt_domain *get_itt_domain(d1::itt_domain_enum idx) {
                if (tbb_domains[idx] == nullptr) { ITT_DoOneTimeInitialization(); }
            ...
            void itt_make_task_group(d1::itt_domain_enum domain, void *group, unsigned long long group_extra,
                ...
                if (__itt_domain *d = get_itt_domain(domain)) {
                    ...
                    if (parent) { itt_id_make(&parent_id, parent, parent_extra); }
                    __itt_string_handle *n = ITT_get_string_handle(name_index);
                    __itt_task_group(d, group_id, parent_id, n);
                }
            }

            void __TBB_EXPORTED_FUNC itt_metadata_str_add(d1::itt_domain_enum domain, void *addr,
            ...
            void __TBB_EXPORTED_FUNC itt_metadata_ptr_add(d1::itt_domain_enum domain, void *addr,
                                                          unsigned long long addr_extra,
            ...
            void __TBB_EXPORTED_FUNC itt_relation_add(d1::itt_domain_enum domain, void *addr0,
            ...
            void __TBB_EXPORTED_FUNC itt_task_begin(d1::itt_domain_enum domain, void *task,
                ...
                if (__itt_domain *d = get_itt_domain(domain)) {
                    ...
                    __itt_id parent_id = itt_null_id;
                    if (task) { itt_id_make(&task_id, task, task_extra); }
                    if (parent) { itt_id_make(&parent_id, parent, parent_extra); }
                    __itt_string_handle *n = ITT_get_string_handle(name_index);
            ...
            void __TBB_EXPORTED_FUNC itt_task_end(d1::itt_domain_enum domain) {
                if (__itt_domain *d = get_itt_domain(domain)) { __itt_task_end(d); }
            }

            void __TBB_EXPORTED_FUNC itt_region_begin(d1::itt_domain_enum domain, void *region,
            ...
            void __TBB_EXPORTED_FUNC itt_region_end(d1::itt_domain_enum domain, void *region,
            ...
            void itt_make_task_group(d1::itt_domain_enum /*domain*/, void* /*group*/,
                                     unsigned long long /*group_extra*/, void* /*parent*/,
                                     unsigned long long /*parent_extra*/,
                                     string_resource_index /*name_index*/) {}
            void itt_metadata_str_add(d1::itt_domain_enum /*domain*/, void* /*addr*/,
                                      unsigned long long /*addr_extra*/, string_resource_index /*key*/,
                                      const char* /*value*/) {}
            void itt_metadata_ptr_add(d1::itt_domain_enum /*domain*/, void* /*addr*/,
                                      unsigned long long /*addr_extra*/, string_resource_index /*key*/,
                                      void* /*value*/) {}
            void itt_relation_add(d1::itt_domain_enum /*domain*/, void* /*addr0*/,
                                  unsigned long long /*addr0_extra*/, itt_relation /*relation*/,
                                  void* /*addr1*/, unsigned long long /*addr1_extra*/) {}
            void itt_task_begin(d1::itt_domain_enum /*domain*/, void* /*task*/,
                                unsigned long long /*task_extra*/, void* /*parent*/,
                                unsigned long long /*parent_extra*/, string_resource_index /*name_index*/) {}
            void itt_task_end(d1::itt_domain_enum /*domain*/) {}
            void itt_region_begin(d1::itt_domain_enum /*domain*/, void* /*region*/,
                                  unsigned long long /*region_extra*/, void* /*parent*/,
                                  unsigned long long /*parent_extra*/, string_resource_index /*name_index*/) {
            }
            void itt_region_end(d1::itt_domain_enum /*domain*/, void* /*region*/,
                                unsigned long long /*region_extra*/) {}
#endif /* __TBB_USE_ITT_NOTIFY */

            const tchar *SyncType_Scheduler = _T("%Constant");
            const tchar *SyncObj_ContextsList = _T("TBB Scheduler");
        }// namespace r1
    }    // namespace detail
}// namespace tbb
