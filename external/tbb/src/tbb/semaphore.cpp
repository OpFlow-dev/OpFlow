...
// TODO: For new win UI port, we can use SRWLock API without dynamic_link etc.
            ...
            static void(WINAPI* __TBB_init_binsem)(SRWLOCK*)
                    = (void(WINAPI*)(SRWLOCK*)) & init_binsem_using_event;
            static void(WINAPI* __TBB_acquire_binsem)(SRWLOCK*)
                    = (void(WINAPI*)(SRWLOCK*)) & acquire_binsem_using_event;
            static void(WINAPI* __TBB_release_binsem)(SRWLOCK*)
            ...
            inline void init_concmon_module() {
                ...
                if (dynamic_link("Kernel32.dll", SRWLLinkTable,
                                 sizeof(SRWLLinkTable) / sizeof(dynamic_link_descriptor))) {
                    __TBB_ASSERT((uintptr_t) __TBB_init_binsem != (uintptr_t) &init_binsem_using_event,
                                 nullptr);
                    __TBB_ASSERT((uintptr_t) __TBB_acquire_binsem != (uintptr_t) &acquire_binsem_using_event,
                                 nullptr);
                    __TBB_ASSERT((uintptr_t) __TBB_release_binsem != (uintptr_t) &release_binsem_using_event,
                                 nullptr);
                }
            }
            ...
            binary_semaphore::binary_semaphore() {
                ...
                if ((uintptr_t) __TBB_init_binsem != (uintptr_t) &init_binsem_using_event) P();
            }
