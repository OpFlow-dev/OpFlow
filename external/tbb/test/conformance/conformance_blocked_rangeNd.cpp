...
void SerialTest() {
    static_assert((oneapi::tbb::blocked_rangeNd<int, DimAmount>::ndims()
                   == oneapi::tbb::blocked_rangeNd<AbstractValueType, DimAmount>::ndims()),
...
TEST_CASE("Construction") {
    ...
    oneapi::tbb::blocked_rangeNd<int, 2>(oneapi::tbb::blocked_range<int>(-8923, 8884, 13),
