                                ...
                                for (int col_y = col_x; col_y < 4; ++col_y) {
                                    ...
                                    for (int col_grain = 1; col_grain < 4; ++col_grain) {
                                        ...
                                        utils::AssertSameType(
                                                static_cast<range_type::page_range_type::const_iterator*>(0),
                                                static_cast<page_type*>(0));
                                        utils::AssertSameType(
                                                static_cast<range_type::row_range_type::const_iterator*>(0),
                                                static_cast<row_type*>(0));
                                        utils::AssertSameType(
                                                static_cast<range_type::col_range_type::const_iterator*>(0),
