...
template <typename InputType, typename OutputType1, typename OutputType2, typename Body1, typename Body2>
...
TEST_CASE("Test function_node body") {
    conformance::test_body_exec<oneapi::tbb::flow::function_node<input_msg, output_msg>, input_msg,
                                output_msg>(oneapi::tbb::flow::unlimited);
}
...
TEST_CASE("function_node constructors") {
    ...
    function_node<int, int, lightweight> lw_node2(g, serial, fun, lightweight(),
...
TEST_CASE("function_node and body copying") {
    conformance::test_copy_body_function<oneapi::tbb::flow::function_node<int, int>,
...
TEST_CASE("function_node superclasses") {
    ...
    conformance::test_inheritance<oneapi::tbb::flow::function_node<input_msg, output_msg>, input_msg,
                                  output_msg>();
}
...
TEST_CASE("function_node buffering") {
    ...
    conformance::test_buffering<
            oneapi::tbb::flow::function_node<input_msg, int, oneapi::tbb::flow::rejecting>, input_msg>(
            oneapi::tbb::flow::unlimited, fun);
    conformance::test_buffering<oneapi::tbb::flow::function_node<input_msg, int, oneapi::tbb::flow::queueing>,
...
TEST_CASE("function_node broadcast") {
    ...
    conformance::test_forwarding<oneapi::tbb::flow::function_node<input_msg, int>, input_msg, int>(
...
TEST_CASE("function_node priority support") {
    conformance::test_priority<oneapi::tbb::flow::function_node<input_msg, int>, input_msg>(
            oneapi::tbb::flow::unlimited);
}
...
//! \brief \ref interface \ref requirement
TEST_CASE("Test function_node and std::invoke") { test_fn_invoke(); }
#endif
