...
class start_time_collection : public start_time_collection_base<start_time_collection> {
    ...
    std::size_t measure_impl() { return measure_median_start_time(arena); }
};
...
TEST_CASE("Check that workers leave faster with leave_policy::fast") {
    ...
    tbb::task_arena ta_automatic_leave {tbb::task_arena::automatic, 1, tbb::task_arena::priority::normal,
                                        tbb::task_arena::leave_policy::automatic};
    tbb::task_arena ta_fast_leave {tbb::task_arena::automatic, 1, tbb::task_arena::priority::normal,
...
TEST_CASE("Parallel Phase retains workers in task_arena") {
    if (utils::get_platform_max_threads() < 2) { return; }
    tbb::task_arena ta_fast1 {tbb::task_arena::automatic, 1, tbb::task_arena::priority::normal,
                              tbb::task_arena::leave_policy::fast};
    tbb::task_arena ta_fast2 {tbb::task_arena::automatic, 1, tbb::task_arena::priority::normal,
                              tbb::task_arena::leave_policy::fast};
    ...
    WARN_MESSAGE(median1 < median2, "Expected workers start new work faster when using parallel_phase");
...
TEST_CASE("Test one-time fast leave") {
    ...
    WARN_MESSAGE(median1 < median2, "Expected one-time fast leave setting to slow workers to start new work");
