...
TEST_CASE("internal mutex concepts") {
    static_assert(mutexes<tbb::spin_mutex, oneapi::tbb::mutex, tbb::speculative_spin_mutex, tbb::null_mutex,
                          tbb::queuing_mutex, tbb::spin_rw_mutex, oneapi::tbb::rw_mutex,
                          tbb::speculative_spin_rw_mutex, tbb::null_rw_mutex, tbb::queuing_rw_mutex>);
