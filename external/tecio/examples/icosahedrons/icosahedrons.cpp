...
int main(int argc, char** argv) {
    ...
    i = TECINI142((char*) "Icosahedral zones with shared connectivity", (char*) "X Y Z P",
                  (char*) "icosahedrons.plt", (char*) ".", &fileFormat, &fileType, &debug, &fileIsDouble);
    ...
    i = TECZNE142((char*) "Icosahedral Zone", &zoneType, &numNodes, &numElems, &numFaces, &iCellMax,
                  &jCellMax, &kCellMax, &solTime, &strandID, &parentZn, &isBlock, &nFConns, &fNMode,
                  &numFaceNodes, &numBFaces, &numBConnections, NULL,
    ...
    INTEGER4 faceNodes[] = {1, 2, 10, 2, 8, 10, 8, 12, 10, 12, 6,  10, 6, 1,  10, 1, 9,  2, 2, 9,
                            7, 2, 7,  8, 8, 7,  4, 8,  4,  12, 12, 4,  3, 12, 3,  6, 6,  3, 5, 6,
                            5, 1, 1,  5, 9, 9,  5, 11, 7,  9,  11, 4,  7, 11, 3,  4, 11, 5, 3, 11};
    ...
    i = TECPOLYFACE142(&numFaces, faceNodeCounts, &faceNodes[0], &faceLeftElems[0], &faceRightElems[0]);
