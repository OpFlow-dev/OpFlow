...
int main() {
    ...
    I = TECINI142((char *) "Example: Multiple polygonal zones",
                  (char *) "X Y P", /* Defines the variables for the data file.
                                    ...
                                    */
                  (char *) "multiplepolygons-HexAndOct.plt", (char *) ".", /* scratch directory */
    ...
    I = TECZNE142((char *) "Zone 1: 3 Hexagons", /* Specifies the name of
                                                ...
                                                * Set Info dialog.
                                                */
                  &ZoneType, &NumPts_Z1, &NumElems_Z1, &NumFaces_Z1, &ICellMax, &JCellMax, &KCellMax,
                  &SolutionTime, &StrandID, &ParentZone, &IsBlock, &NumFaceConnections, &FaceNeighborMode,
                  &TotalNumFaceNodes_Z1, &TotalNumBndryFaces_Z1, &TotalNumBndryConns_Z1, NULL, ValueLocation,
                  NULL, &SharConn);
    /* DOCEND */
     ...
     * element itself.
     */
    for (INTEGER4 ii = 0; ii < 6; ii++) FaceRightElems_Z1[ii] = 1;

    for (INTEGER4 ii = 6; ii < 11; ii++) FaceRightElems_Z1[ii] = 2;

    for (INTEGER4 ii = 11; ii <= 14; ii++) FaceRightElems_Z1[ii] = 3;

    I = TECPOLYFACE142(&NumFaces_Z1, NULL, /* Not used for polygon zones */
                       FaceNodes_Z1, FaceLeftElems_Z1, FaceRightElems_Z1);
    ...
    I = TECPOLYBCONN142(&TotalNumBndryFaces_Z1, FaceBndryConnectionCounts_Z1, FaceBndryConnectionElems_Z1,
    ...
    I = TECZNE142((char *) "Zone 2: 1 Hexagon and 1 Octagon", &ZoneType, &NumPts_Z2, &NumElems_Z2,
                  &NumFaces_Z2, &ICellMax, &JCellMax, &KCellMax, &SolutionTime, &StrandID, &ParentZone,
                  &IsBlock, &NumFaceConnections_Z2, &FaceNeighborMode, &TotalNumFaceNodes_Z2,
                  &TotalNumBndryFaces_Z2, &TotalNumBndryConns_Z2, NULL, ValueLocation, NULL, &SharConn);
    /* DOCEND */
     ...
     * nodes and faces, the right element for every face is the
     * element itself. */
    for (INTEGER4 ii = 0; ii < 6; ii++) FaceRightElems_Z2[ii] = 1;

    for (INTEGER4 ii = 6; ii < 13; ii++) FaceRightElems_Z2[ii] = 2;

    I = TECPOLYFACE142(&NumFaces_Z2, NULL, FaceNodes_Z2, FaceLeftElems_Z2, FaceRightElems_Z2);
    ...
    I = TECPOLYBCONN142(&TotalNumBndryFaces_Z2, FaceBndryConnectionCounts_Z2, FaceBndryConnectionElems_Z2,
