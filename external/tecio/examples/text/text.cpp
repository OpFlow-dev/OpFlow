...
int main(int argc, const char *argv[]) {
    ...
    I = TECINI142((char *) "Text", (char *) "X Y P", (char *) "text.plt", (char *) ".", &fileFormat,
    ...
    I = TECTXT142(&XPos, &YPos, &ZPos, &PosCoordMode, &AttachToZone, &Zone, &Font, &FontHeightUnits,
                  &FontHeight, &BoxType, &BoxMargin, &BoxLineThickness, &BoxColor, &BoxFillColor, &Angle,
                  &Anchor, &LineSpacing, &TextColor, &Scope, &Clipping, Text, MFC);
