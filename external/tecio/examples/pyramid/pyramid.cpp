...
int main() {
    ...
    I = TECZNE142((char *) "Polyhedral Zone (Octahedron)", &ZoneType, &NumNodes, &NumElems, &NumFaces,
                  &ICellMax, &JCellMax, &KCellMax, &SolTime, &StrandID, &ParentZone, &IsBlock, &NFConns,
                  &FNMode, &NumFaceNodes, &NumBConns, &NumBItems, PassiveVarArray, ValueLocArray,
                  VarShareArray, &ShrConn);
    ...
    I = TECPOLYFACE142(&NumFaces, FaceNodeCounts, /* The face node counts array */
