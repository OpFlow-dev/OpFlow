...
int main() {
    ...
    I = TECINI142((char *) "Multiple polyhedral zones", /* Name of the entire
                  ...
                  (char *) "X Y Z P",                   /* Defines the variables for the data
                                      ...
                                      * X is Var 1).
                                      */
                  (char *) "Arrow.plt", (char *) ".",   /* Scratch Directory */
    ...
    I = TECZNE142((char *) "Zone 1: Rectangular Solid", &ZoneType, &NumPts_Rect, &NumElems_Rect,
                  &NumFaces_Rect, &ICellMax, &JCellMax, &KCellMax, &SolutionTime, &StrandID, &ParentZone,
                  &IsBlock, &NumFaceConnections, &FaceNeighborMode, &TotalNumFaceNodes_Rect,
                  &NumConnBndryFaces_Rect, &TotalNumBndryConns_Rect, NULL, ValueLocation, NULL, &SharConn);
    /* DOCEND */
    ...
    for (INTEGER4 ii = 0; ii < 4; ii++) Z_Rect[ii] = 0;

    for (INTEGER4 ii = 4; ii < NumPts_Rect; ii++) Z_Rect[ii] = -2;
    ...
    for (INTEGER4 ii = 0; ii < NumFaces_Rect; ii++) FaceNodeCounts_Rect[ii] = 4;
    ...
    I = TECPOLYFACE142(&NumFaces_Rect, FaceNodeCounts_Rect, FaceNodes_Rect, FaceLeftElems_Rect,
                       FaceRightElems_Rect);
    /* DOCEND */
    ...
    I = TECPOLYBCONN142(&NumConnBndryFaces_Rect, FaceBndryConnCounts_Rect, FaceBndryConnElems_Rect,
    ...
    I = TECZNE142((char *) "Zone 2: Prism", &ZoneType, &NumPts_Prism, &NumElems_Prism, &NumFaces_Prism,
                  &ICellMax, &JCellMax, &KCellMax, &SolutionTime, &StrandID, &ParentZone, &IsBlock,
                  &NumFaceConnections, &FaceNeighborMode, &TotalNumFaceNodes_Prism, &NumConnBndryFaces_Prism,
                  &TotalNumBndryConns_Prism, NULL, ValueLocation, NULL, &SharConn);
    /* DOCEND */
     ...
     */
    for (INTEGER4 ii = 0; ii < 3; ii++) FaceNodeCounts_Prism[ii] = 4;

    for (INTEGER4 ii = 3; ii < NumFaces_Prism; ii++) FaceNodeCounts_Prism[ii] = 3;
    ...
    I = TECPOLYFACE142(&NumFaces_Prism, FaceNodeCounts_Prism, FaceNodes_Prism, FaceLeftElems_Prism,
    ...
    I = TECPOLYBCONN142(&NumConnBndryFaces_Prism, FaceBndryConnCounts_Prism, FaceBndryConnElems_Prism,
