...
int main(int argc, const char *argv[]) {
     ...
     * header information
     */
    I = TECINI142((char *) "Square Geometries", (char *) "X Y P", (char *) "squares.plt", (char *) ".",
    ...
    for (INTEGER4 ii = 0; ii <= 7; ii++) {
        ...
        I = TECGEO142(&XPos, &YPos, &ZPos, &PosCoordMode, &AttachToZone, &Zone, &Color, &FillColor, &IsFilled,
                      &GeomType, &LinePattern, &PatternLength, &LineThick, &NumPts, &ArrowStyle, &ArrowAttach,
                      &ArrowSize, &ArrowAngle, &Scope, &Clipping, &NumSegments, &NumSegPts, &XGeomData,
                      &YGeomData, &ZGeomData, MFC);
    }
