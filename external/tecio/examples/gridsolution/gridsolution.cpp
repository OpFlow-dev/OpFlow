...
int main() {
    ...
    I = TECINI142((char *) "Example: Separate grid and solution files",
                  (char *) "X Y Z",                               /* Defines the variables for the data file.
                                    ...
                                    */
                  (char *) "gridsolution-grid.plt", (char *) ".", /* scratch directory */
    ...
    I = TECZNE142((char *) "Dodecahedron", /* Name of the zone. */
                  &ZoneType, &NumPts, &NumElems, &NumFaces, &ICellMax, &JCellMax, &KCellMax, &SolutionTime,
                  &StrandID, &ParentZone, &IsBlock, &NumFaceConnections, &FaceNeighborMode,
                  &TotalNumFaceNodes, &TotalNumBndryFaces, &TotalNumBndryConns, NULL,
    ...
    for (int J = 0; J < NumFaces; J++) FaceNodeCounts[J] = 5;
    ...
    I = TECPOLYFACE142(&NumFaces, FaceNodeCounts, FaceNodes, FaceLeftElems, FaceRightElems);
    ...
    for (int J = 0; J < 5; J++) {
        ...
        I = TECINI142((char *) "Example: Separate grid and solution files",
                      (char *) "P T",                 /* Defines the variables for the solution file.
                                      ...
                                      * the grid file.
                                      */
                      SolutionFileName, (char *) ".", /* scratch directory */
                      &FileFormat, &FileType, &Debug, &VIsDouble);
        /* DOCEND */
        ...
        I = TECZNE142(ZoneName, &ZoneType, &NumPts, &NumElems, &NumFaces, &ICellMax, &JCellMax, &KCellMax,
