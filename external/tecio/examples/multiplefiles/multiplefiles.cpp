...
int main(int argc, const char *argv[]) {
    ...
    I = TECINI142((char *) "SIMPLE DATASET", /* Name of the entire dataset.*/
                  ...
                  (char *) "X1 Y1 P1",                              /* Defines the variables for the data
                                       ...
                                       * X1 is Var 1).
                                       */
                  (char *) "multiplefiles-file1.plt", (char *) ".", /* Scratch Directory */
    ...
    I = TECZNE142((char *) "Ordered Zone", &ZoneType, &IMax, &JMax, &KMax, &ICellMax, &JCellMax, &KCellMax,
                  ...
                  &TotalNumBndryFaces, &TotalNumBndryConn, NULL, NULL, NULL, &ShrConn);
     ...
     */
    I = TECINI142((char *) "Auxiliary Data", (char *) "X1 Y1 P1", (char *) "multiplefiles-file2.plt",
    ...
    I = TECZNE142((char *) "Ordered Zone2", &ZoneType, &IMax, &JMax, &KMax, &ICellMax, &JCellMax, &KCellMax,
                  &SolTime, &StrandID, &ParentZn, &IsBlock, &NFConns, &FNMode, &TotalNumFaceNodes,
                  &TotalNumBndryFaces, &TotalNumBndryConn, NULL, NULL, NULL, &ShrConn);
    ...
    I = TECAUXSTR142((char *) "DeformationValue", DeformationValue);
