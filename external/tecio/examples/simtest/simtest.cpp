...
int main(int argc, const char *argv[]) {
     ...
     * header information
     */
    I = TECINI142((char *) "SIMPLE DATASET", (char *) "X Y P", (char *) "simtestcpp-t.plt", (char *) ".",
     ...
     */
    I = TECZNE142((char *) "Simple Zone", &ZoneType, &IMax, &JMax, &KMax, &ICellMax, &JCellMax, &KCellMax,
                  &SolTime, &StrandID, &ParentZn, &IsBlock, &NFConns, &FNMode, 0, /* TotalNumFaceNodes */
