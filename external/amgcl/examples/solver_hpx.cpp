...
int main(int argc, char *argv[]) {
    boost::program_options::options_description options("Usage: " HPX_APPLICATION_STRING " [options]");

    options.add_options()("size,n", boost::program_options::value<int>()->default_value(32), "problem size")(
            "grain,g", boost::program_options::value<int>()->default_value(4096), "grain size");
