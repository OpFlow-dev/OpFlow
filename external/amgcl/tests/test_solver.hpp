...
void test_solver(const Matrix &A, std::shared_ptr<typename Backend::vector> const &f,
                 std::shared_ptr<typename Backend::vector> &x, amgcl::runtime::solver::type solver,
                 amgcl::runtime::relaxation::type relaxation, amgcl::runtime::coarsening::type coarsening,
                 typename Backend::params const &bprm, bool test_null_space = false) {
...
//---------------------------------------------------------------------------
template <class Backend, class Matrix>
void test_rap(const Matrix &A, std::shared_ptr<typename Backend::vector> const &f,
              std::shared_ptr<typename Backend::vector> &x, amgcl::runtime::solver::type solver,
              amgcl::runtime::relaxation::type relaxation, typename Backend::params const &bprm) {
    boost::property_tree::ptree prm;
    prm.put("precond.type", relaxation);
    prm.put("solver.type", solver);

    amgcl::make_solver<amgcl::relaxation::as_preconditioner<Backend, amgcl::runtime::relaxation::wrapper>,
                       amgcl::runtime::solver::wrapper<Backend>>
            solve(A, prm, bprm);
...
void test_problem(size_t n, std::vector<ptr_type> ptr, std::vector<col_type> col, std::vector<value_type> val,
                  std::vector<rhs_type> rhs, typename Backend::params const &bprm) {
    amgcl::runtime::coarsening::type coarsening[]
            = {amgcl::runtime::coarsening::aggregation, amgcl::runtime::coarsening::smoothed_aggregation,
               amgcl::runtime::coarsening::smoothed_aggr_emin, amgcl::runtime::coarsening::ruge_stuben};
    ...
    amgcl::runtime::solver::type solver[]
            = {amgcl::runtime::solver::cg,        amgcl::runtime::solver::bicgstab,
               amgcl::runtime::solver::bicgstabl, amgcl::runtime::solver::gmres,
               amgcl::runtime::solver::lgmres,    amgcl::runtime::solver::fgmres,
    ...
    for (amgcl::runtime::solver::type s : solver) {
        ...
        try {
            test_solver<Backend>(amgcl::adapter::zero_copy_direct(n, ptr.data(), col.data(), val.data()), y,
                                 x, s, relaxation[0], coarsening[0], bprm);
    ...
    for (amgcl::runtime::relaxation::type r : relaxation) {
        ...
        try {
            test_solver<Backend>(amgcl::adapter::zero_copy_direct(n, ptr.data(), col.data(), val.data()), y,
                                 x, solver[0], r, coarsening[0], bprm);
        } catch (const std::logic_error &) {}

        try {
            std::cout << "Relaxation as preconditioner: " << r << std::endl;

            test_rap<Backend>(amgcl::adapter::zero_copy_direct(n, ptr.data(), col.data(), val.data()), y, x,
                              solver[0], r, bprm);
        } catch (const std::logic_error &) {}
    }
    ...
    for (amgcl::runtime::coarsening::type c : coarsening) {
        ...
        try {
            test_solver<Backend>(amgcl::adapter::zero_copy_direct(n, ptr.data(), col.data(), val.data()), y,
                                 x, solver[0], relaxation[0], c, bprm);
        } catch (const std::logic_error &) {}
        ...
        switch (c) {
            ...
            case amgcl::runtime::coarsening::smoothed_aggr_emin:
                test_solver<Backend>(amgcl::adapter::zero_copy_direct(n, ptr.data(), col.data(), val.data()),
