...
TEST_SUBMODULE(callbacks, m) {
    ...
    m.def("test_callback3",
          [](const std::function<int(int)> &func) { return "func(43) = " + std::to_string(func(43)); });
    ...
    m.def("test_unpacking_and_keywords2", [](py::function f) {
        ...
        return f("positional", *py::make_tuple(1), 2, *py::make_tuple(3, 4), 5, "key"_a = "value", **kwargs1,
                 "b"_a = 2, **kwargs2, "e"_a = 5);
    });
    ...
    m.def("test_arg_conversion_error2",
          [](py::function f) { f(234, "expected_name"_a = UnregisteredType(), "kw"_a = 567); });
    ...
    m.def("test_async_callback", [](callback_f f, py::list work) {
        ...
        for (auto i : work) start_f(py::cast<int>(i));
    });
}
