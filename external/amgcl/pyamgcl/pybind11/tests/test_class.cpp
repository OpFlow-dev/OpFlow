...
TEST_SUBMODULE(class_, m) {
    ...
    pet_class.def(py::init<std::string, std::string>()).def("name", &Pet::name).def("species", &Pet::species);
    ...
    m.def("check_instances", [](py::list l) {
        return py::make_tuple(py::isinstance<py::tuple>(l[0]), py::isinstance<py::dict>(l[1]),
                              py::isinstance<Pet>(l[2]), py::isinstance<Pet>(l[3]), py::isinstance<Dog>(l[4]),
    ...
    m.def("check_type", [](int category) {
        ...
        if (category == 1) return py::type::of<DerivedClass1>();
        else
    ...
    m.def("mismatched_holder_2", []() {
        ...
        py::class_<MismatchDerived2, std::shared_ptr<MismatchDerived2>, MismatchBase2>(mod,
                                                                                       "MismatchDerived2");
    });
    ...
    struct MyDerived : MyBase {
        static std::unique_ptr<MyDerived> make() { return std::unique_ptr<MyDerived>(new MyDerived()); }
    };
    ...
    m.add_object("implicitly_convert_variable_fail", [&] {
        auto f = [](PyObject *, PyObject *args) -> PyObject * {
            ...
            } catch (const py::cast_error &e) { return py::str(e.what()).release().ptr(); }
    ...
    m.def("test_error_after_conversions", [](StringWrapper) -> NotRegistered { return {}; });
    ...
    py::class_<BaseWithNested::Nested>(baseWithNested_class, "Nested").def_static("get_name", []() {
        return "BaseWithNested::Nested";
    });
    py::class_<DerivedWithNested::Nested>(derivedWithNested_class, "Nested").def_static("get_name", []() {
...
#define CHECK_BROKEN(N)                                                                                      \
    static_assert(std::is_same<typename Breaks##N::type, BreaksBase<-N>>::value, "Breaks1 has wrong type!");
