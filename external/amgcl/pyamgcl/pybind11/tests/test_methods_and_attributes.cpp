...
public:
    ...
    std::string toString() { return "ExampleMandA[value=" + std::to_string(value) + "]"; }
...
TEST_SUBMODULE(methods_and_attributes, m) {
            ...
            .def_static("add_mixed_overloads2",
                        []() {
                            ...
                            emna.def_static("overload_mixed2",
                                            static_cast<py::str (*)(float)>(&ExampleMandA::overloaded))
                                    .def("overload_mixed2", static_cast<py::str (ExampleMandA::*)(int, int)>(
                                                                    &ExampleMandA::overloaded));
                        })
    ...
    py::class_<TestProperties>(m, "TestProperties")
            ...
            .def_property_static(
                    "def_property_static", [](py::object) { return TestProperties::static_get(); },
    ...
    py::class_<StrIssue>(m, "StrIssue")
            .def(py::init<int>())
            .def(py::init<>())
            .def("__str__", [](const StrIssue &si) { return "StrIssue[" + std::to_string(si.val) + "]"; });
