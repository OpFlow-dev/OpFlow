...
TEST_SUBMODULE(buffers, m) {
    ...
    public:
        ...
        float operator()(py::ssize_t i, py::ssize_t j) const { return m_data[(size_t)(i * m_cols + j)]; }

        float &operator()(py::ssize_t i, py::ssize_t j) { return m_data[(size_t)(i * m_cols + j)]; }
    ...
    py::class_<Matrix>(m, "Matrix", py::buffer_protocol())
            ...
            .def("__getitem__",
                 [](const Matrix &m, std::pair<py::ssize_t, py::ssize_t> i) {
                     if (i.first >= m.rows() || i.second >= m.cols()) throw py::index_error();
    ...
    struct Buffer {
        ...
        py::buffer_info get_buffer_info() {
            return py::buffer_info(&value, sizeof(value), py::format_descriptor<int32_t>::format(), 1);
        }
    };
    ...
    public:
        ...
        py::buffer_info get_buffer_info() const {
            return py::buffer_info(value.get(), sizeof(*value), py::format_descriptor<int32_t>::format(), 1);
        }
    ...
    py::class_<py::buffer_info>(m, "buffer_info")
            ...
            .def("__repr__", [](py::handle self) {
                return py::
                        str("itemsize={0.itemsize!r}, size={0.size!r}, format={0.format!r}, ndim={0.ndim!r}, "
                            "shape={0.shape!r}, strides={0.strides!r}, readonly={0.readonly!r}")
                                .format(self);
            });
